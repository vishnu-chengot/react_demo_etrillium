            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                ...
                <nav className="cs_nav">
                  ...
                  >
                    {/* <li className="menu-item-has-children"> The classname "menu-item-has-children is the css for dropdown we can use <DropDown> to access dropdown menu"*/}
                    <li>
                      <Link to="/">Home</Link>
                      {/* <DropDown>
                        <ul>
                    ...
                    <li>
                      <Link to="/doctors">Find Advocate</Link>
                    </li>
                    {/* <li>
