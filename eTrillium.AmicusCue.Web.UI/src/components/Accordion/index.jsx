...
export default function Accordion({ data, variant }) {
  const [openItemIndex, setOpenItemIndex] = useState(0); // Initialize with -1 for no item open initially
  const [firstItemOpen, setFirstItemOpen] = useState(false); // Set the first item to open initially
